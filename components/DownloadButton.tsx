  ...
  return (
    <div className="w-full h-28 mb-5 flex justify-center items-center">
      ...
      <div
        ...
        className="w-60 hidden flex flex-col justify-center items-center"
      >
        <div
          id="progress-bar"
          className="w-full h-7 bg-slate-100 flex items-center relative shadow-2xl shadow-red-500"
        >
          <div
            id="progress-fill"
            className="absolute w-full h-full bg-red-500 bg-gradient-to-r from-pink-300 to-red-500"
          ></div>
          <div
            id="progress-text"
      ...
      <div id="progress-result" className="hidden text-sm bg-white p-4">
        <TextReveal text="Congratulations !" />
        <TextReveal text="You are downloaded in my ❤️ !" />
      </div>
    </div>
  );
}
